[xde-theme-circuits -- release notes.  2021-12-07]: #

Maintenance Release 1.2
=======================

This is the third release of the `xde-theme-circuits` package.  This
...
[GitHub](https://github.com/bbidulock/xde-theme-circuits/issues).
